 ...
 */
public abstract class AbstractTm4eTemplateContextType extends TemplateContextType {

	public AbstractTm4eTemplateContextType(final String contextTypeId, final String contextTypeName) {
